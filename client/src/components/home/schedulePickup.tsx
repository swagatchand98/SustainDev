...
const SchedulePickup: React.FC = () => {
  ...
  const [wasteItems, setWasteItems] = useState<WasteItem[]>([
    ...
    { id: "textile", name: "Textile Waste", price: 20, image: textile, quantity: 0 }
  ]);
  ...
  const handleConfirmPickup = () => {
    ...
    console.log("Scheduling pickup for:", wasteItems.filter(item => item.quantity > 0));
  ...
  return (
    <section 
      id="order" 
      className="w-full justify-items-center bg-gradient-to-b from-green-gradient-2 to-green-gradient-1 py-8 md:py-12"
      aria-labelledby="waste-selection-heading"
    >
      <ScrollReveal 
        animation="fadeIn" 
        className="flex justify-center items-center font-judson font-bold text-xl s:text-2xl md:text-4xl mt-10 md:mt-15 lg:mt-15 xl:mt-20"
      >
      ...
      >
        Select the types and quantities of recyclable waste you wish to have collected. Earn rewards for contributing to a cleaner environment.
      </ScrollReveal>

      <ScrollReveal 
        animation="fadeIn" 
        className="grid grid-cols-2 grid-rows-3 md:grid-cols-3 md:grid-rows-2 justify-items-center gap-5 md:gap-10 xs:m-5 md:m-10 my-15 md:mt-8 md:mb-8 lg:mb-10 xl:mb-15"
      >
